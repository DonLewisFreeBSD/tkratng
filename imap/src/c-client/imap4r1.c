...
static char *hdrheader[] = {
  "BODY.PEEK[HEADER.FIELDS (Newsgroups Content-Type Content-MD5 Content-Disposition Content-Language Content-Location",
  "BODY.PEEK[HEADER.FIELDS (Newsgroups Content-Type Content-Disposition Content-Language Content-Location",
  "BODY.PEEK[HEADER.FIELDS (Newsgroups Content-Type Content-Language Content-Location",
  "BODY.PEEK[HEADER.FIELDS (Newsgroups Content-Type Content-Location",
  "BODY.PEEK[HEADER.FIELDS (Newsgroups Content-Type"
};
